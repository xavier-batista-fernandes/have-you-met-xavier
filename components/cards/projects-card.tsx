...
export function ProjectsCard() {
  return (
    <div className="h-full max-w-screen overflow-y-scroll p-10">
...
function Timeline() {
  ...
  return (
    ...
    >
      <div className="relative h-[50vh] w-[300%] border-blue-500 px-[5%] text-center">
        <div
          id="top-section"
        ...
        >
          <BoxArrowInIcon className="animateSway absolute -left-7 hidden h-6 -translate-y-1/2 md:block"></BoxArrowInIcon>
          <p className="absolute bottom-1 left-4 hidden text-sm md:block">
            One day I had an idea.
          </p>
          <div className="absolute left-0 aspect-square h-2 -translate-y-1/2 rounded-full bg-black"></div>
          <p className="absolute top-1 left-4 hidden text-sm md:block">
            ... So I started coding.
          </p>

          <ArrowLoadingIcon className="animateRotate absolute -right-8 hidden h-6 -translate-y-1/2 md:block"></ArrowLoadingIcon>
          <p className="absolute right-4 bottom-1 hidden text-sm md:block">
            Now I'm here!
          </p>
          <div className="absolute right-0 aspect-square h-2 -translate-y-1/2 rounded-full bg-black"></div>
        ...
        >
          <div id="2025-d" className="h-full w-1/3">
            <div className="mx-auto flex w-2/3 flex-col justify-center gap-1 overflow-hidden border-green-700">
              <div className="h-2/5">
          ...
          <div id="2024-d" className="h-full w-1/3">
            <div className="mx-auto flex w-2/3 flex-col justify-center gap-1 border-green-700">
              <div className="h-2/5">
