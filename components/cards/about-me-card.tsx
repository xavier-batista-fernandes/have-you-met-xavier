    ...
    return (
      <p className="text-sm leading-relaxed text-gray-600">
        ...
        <button
          ...
          onClick={() => {
            window.open(
              'https://www.google.com/maps/search/?api=1&query=Leiria',
              '_blank'
            )
          }}
          className="inline-block cursor-pointer bg-clip-text font-bold text-transparent"
          style={{
  ...
  return (
    <div className="h-full overflow-y-scroll p-10">
      <div className="flex flex-col gap-4">
        ...
        <p>
          I also got into solving Rubik’s Cubes. I learned how to solve them
          quickly, and that hobby took me all the way to official competitions
          here in Portugal. I’ve met amazing people there, and you can even find
          me in the world rankings.
        </p>
        <p>
          At home, I always keep a jigsaw puzzle on the table. I like the slow
          process of building it piece by piece until the picture comes alive.
          And when one puzzle is finished, I usually jump straight into the next
          challenge.
        </p>
