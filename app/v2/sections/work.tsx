...
export function WorkSection() {
  return (
    <section id="work" className="min-h-screen scroll-mt-20">
      <div className="relative h-full">
        <div className="flex flex-col gap-4">
          <div className="bg-black lg:sticky lg:top-20">
          ...
          <h2 className="font-bold text-[#5b5b5b]">
          ...
          <p>
            During my master's degree, I worked as a teaching assistant. I
            helped guide students through programming courses, which was a
            rewarding way to share what I had learned and sharpen my own skills
            along the way.
          </p>
          <p>
            ...
            love solving problems that make technology more useful and
            accessible.
          </p>
        </div>
      </div>
